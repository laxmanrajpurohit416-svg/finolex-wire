...
import wireImage from "../assets/images/1sqmm.png";
import {
  FaShieldAlt,
  FaTag,
  FaPalette,
...
function ProductPage1sqmm() {
  ...
  return (
    <div className="product-page">
      ...
      {/* TITLE */}
      <h1 className="product-title">Premium Quality Wire 1 Sq MM - {wireColor}</h1>
      ...
      <div className="info-card">
        ...
        <div className="info-row">
          ...
          <div>
            <strong>Wire Size :</strong> 1 Sq MM
          </div>
        </div>
...
export default ProductPage1sqmm;
